...
export default function TopNavigationBar() {
  ...
  return (
   <>
           <div className={` p-5 w-[100%] fixed shadow-xl ${theme ?"top--navigation--bar--tag":"top--navigation--bar--tag--dark"} flex flex-row justify-between items-center`}>
              ...
              className=" flex">
                    ...
                    fill={`${theme?'black':'white'}`}>
                      ...
                      <p className={`${theme?"title---logo---tag--mobile":"title---logo---tag--mobile--dark"}`}>Certify</p>
              </div>
              ...
              >
               ...
               viewBox="0 -960 960 960" 
               width="30px" 
               fill={`${theme?"black":"#e3e3e3"}`}>
                <path 
                d="M120-240v-80h520v80H120Zm664-40L584-480l200-200 56 56-144 144 144 144-56 56ZM120-440v-80h400v80H120Zm0-200v-80h520v80H120Z"/></svg>
              </div>
                 </div>
           </div>
   </>
